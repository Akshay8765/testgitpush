...
#d = collection.find({'$or': [{'item' : 'sketh pad'}, {'qty' : {'$gte' : 75}}]})
#d = collection.update_one({'item': 'canvas'},{'$set' : {'item' : 'akshay'}})
d = collection.delete_one({'item' : 'akshay'})
d = collection.find({'item' : 'akshay'})
